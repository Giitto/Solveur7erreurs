...
/*        if (firstImage.getWidth() != secondImage.getWidth()
    ...
    public static double pourcentErreur(@NotNull Bitmap firstImage, @NotNull Bitmap secondImage) {
        Bitmap bmp = secondImage.copy(secondImage.getConfig(), true);
...
/*        if (firstImage.getWidth() != secondImage.getWidth()
    ...
    public static double pourcentErreur2(@NotNull Bitmap firstImage, @NotNull Bitmap secondImage,int x1,int y1,int x2, int y2) {
